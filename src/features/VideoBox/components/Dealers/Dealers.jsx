...
export const Dealers = ({ dealers, setDealers, showForm, setShowForm }) => {
  return (
    <div className={showForm ? "dealers_container_blur" : "dealers_container"}>
      <div className="dealers_bg">
        <img
          className="dealers_bg_img"
          alt="homeowners bg"
          src="./assets/images/enium_dealers_bg.jpg"
        />
      </div>
          ...
          <div className="dealers_footer">
            ...
            <div className="dealers_footer_content">
              ...
              <div className="dealers_footer_content_item_last">
                "Financine with has changedour business and mav he our sinole
                most imnortant partnershin. They are different than other solar
                financino companies hecause theu understand thabnsi. ness from
                the solar companies perspective. Thev put the customer
                expirience first which trans- lates to sand thine for us."
              </div>
            </div>
          </div>
        </div>
